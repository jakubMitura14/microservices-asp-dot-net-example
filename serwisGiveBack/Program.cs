            ...
            Host.CreateDefaultBuilder(args)
                .ConfigureWebHostDefaults(webBuilder =>
                {
                    webBuilder.UseSerilog((context, loggerConfig)=> {
                        ...
                        var telemtryConifguration = TelemetryConfiguration.CreateDefault(); telemtryConifguration.InstrumentationKey = context.Configuration["ApplicationInsights:InstrumentationKey"];
